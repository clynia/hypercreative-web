<?php $HC_LANG='en'; $HC_EN='/founder/'; $HC_ES='/es/fundador/'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="en"><head>
<!-- Google Tag Manager -->
...
<title>Alfonso Gonz&aacute;lez Aguilar, founder | Hypercreative</title>
<meta name="description" content="Founder of Hypercreative. He composed the music for Klaus, flew airliners for Iberia Regional and founded Sounditi to measure what people feel."><?php echo hc_hreflang(); ?><meta name="robots" content="index,follow"><meta property="og:site_name" content="Hypercreative"><meta property="og:locale" content="en_US"><meta property="og:type" content="profile"><meta property="og:title" content="Alfonso Gonz&aacute;lez Aguilar, founder | Hypercreative"><meta property="og:description" content="Founder of Hypercreative. He composed the music for Klaus, flew airliners for Iberia Regional and founded Sounditi to measure what people feel."><meta property="og:url" content="https://hypercreativemethod.com/founder/"><meta property="og:image" content="https://hypercreativemethod.com/assets/founder/og-alfonso-gonzalez-aguilar.jpg"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Alfonso Gonz&aacute;lez Aguilar, founder | Hypercreative"><meta name="twitter:description" content="Founder of Hypercreative. He composed the music for Klaus, flew airliners for Iberia Regional and founded Sounditi to measure what people feel."><meta name="twitter:image" content="https://hypercreativemethod.com/assets/founder/og-alfonso-gonzalez-aguilar.jpg">
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "ProfilePage", "url": "https://hypercreativemethod.com/founder/", "inLanguage": "en", "mainEntity": {"@type": "Person", "@id": "https://hypercreativemethod.com/#alfonso", "name": "Alfonso González Aguilar", "alternateName": "Alfonso G. Aguilar", "jobTitle": "Founder and keynote speaker", "worksFor": {"@id": "https://hypercreativemethod.com/#org"}, "url": "https://hypercreativemethod.com/founder/", "image": "https://hypercreativemethod.com/assets/founder/alfonso-gonzalez-aguilar.jpg", "description": "Founder of Hypercreative. Composer of the music for the animated film Klaus, former airline pilot for Iberia Regional and founder of Sounditi."}}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://hypercreativemethod.com/"}, {"@type": "ListItem", "position": 2, "name": "Founder", "item": "https://hypercreativemethod.com/founder/"}]}</script>
...
.fhero{display:grid;gap:1.6rem;margin-top:1.4rem}.fhero h1.t{margin:0 0 .9rem}.fphoto{margin:0}.fphoto img{display:block;width:100%;height:auto;border:1px solid var(--line);border-radius:4px;background:#e9e8e4}.fphoto figcaption{margin-top:.55rem;font-size:.8rem;color:var(--mute)}@media(min-width:761px){.fhero{grid-template-columns:1.2fr .8fr;gap:2.6rem;align-items:end}.fhero .dek{margin-bottom:.4rem}}.fnext{display:flex;flex-wrap:wrap;gap:1rem 2.2rem;margin-top:2.4rem;padding-top:1.4rem;border-top:1px solid var(--line)}
</style></head><body>
...
<main class="wrap"><a class="back" href="/">&#8592; Home</a><div class="fhero"><div><h1 class="t">Alfonso Gonz&aacute;lez Aguilar</h1><p class="dek">Founder of Hypercreative. He has worked in three places where mistakes are expensive: film, an airliner cockpit and a company that measured what people feel. The method was born in the first.</p></div><figure class="fphoto"><picture><source type="image/webp" srcset="/assets/founder/alfonso-gonzalez-aguilar-600.webp 600w, /assets/founder/alfonso-gonzalez-aguilar.webp 1000w" sizes="(min-width:761px) 290px, 100vw"><img src="/assets/founder/alfonso-gonzalez-aguilar.jpg" srcset="/assets/founder/alfonso-gonzalez-aguilar-600.jpg 600w, /assets/founder/alfonso-gonzalez-aguilar.jpg 1000w" sizes="(min-width:761px) 290px, 100vw" width="1000" height="1250" alt="Alfonso Gonz&aacute;lez Aguilar, founder of Hypercreative" fetchpriority="high"></picture><figcaption>Photo: Daniel Smith</figcaption></figure></div><article><h2>A method that was not built to sell</h2><p>Hypercreative started as an internal tool. Alfonso built it to train his own film and production teams, where the schedule is impossible, the budget runs out, the brief changes halfway and the work still has to be brilliant on time. When it worked, he turned it into a method that could be taught without him in the room. Companies came later, asking for it.</p><h2>Creating against a deadline</h2><p>He composed the music for Klaus, the Oscar-nominated animated film. For the eighty minutes of music that made it into the film, eight hours and twenty-three minutes were written: more than six times what survived. That ratio is the method in miniature. Generate without judging, then judge without generating.</p><h2>Rehearsing the failure first</h2><p>He flew airliners for Iberia Regional. From the cockpit comes a habit that runs through all of the training: failures are rehearsed in the simulator, not on the day they happen. That is why, in our programs, the rules change on purpose.</p><h2>Measuring what people feel</h2><p>He founded Sounditi, a company that measured the emotion and attention of real people watching audiovisual work, second by second: first with EEG and sensors in a studio, later with the camera of any phone. It left the method with a conviction. Creativity is not a gift: it is trained, and training it leaves a measurable trace.</p><h2>The book</h2><p>He has written <em>De Creativo a Hipercreativo</em>, the book that lays out the whole method, in Spanish.</p><div class="fnext"><a class="back" href="/what-we-do/">Keynotes and training &#8594;</a><a class="back" href="/#request">Start a conversation &#8594;</a></div></article></main><?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/footer.php'; ?>
</body></html>