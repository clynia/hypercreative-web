...
window.HCW=(function(){
  ...
  var TYPES={
    ...
    explorer:{name:"El Explorador",family:"Feed",one:"Coleccionas mundos que no son el tuyo.",
      ...
      shadow:"Este mes vuelve a cavar hondo en tu <strong>propio</strong> oficio. La amplitud con tu terreno descuidado te convierte en un diletante de tu propio trabajo.",
    ...
    notary:{name:"El Notario",family:"Sharpen",one:"Cazas el detalle raro que todos los demás pasan por alto.",
    ...
    collider:{name:"El Colisionador",family:"Sharpen",one:"Unes cosas que no tenían por qué encontrarse.",
      ...
      shadow:"Este mes <strong>llena el depósito de material en bruto</strong>. Bajo presión tiras de la conexión cómoda; solo un pozo más hondo te da una más valiente.",
  ...
  var INFLECT={
    ...
    explorer:{
      ...
      sketcher:"Tu lado Bocetista saca algo de un campo ajeno y lo pone a trabajar de inmediato, soltando una docena de usos rápidos antes de cortar en frío casi todos.",
      ...
      persona:"Tu lado Personaje se pone el traje de forastero cuando quieres, y se mete a propósito en el papel del que sale a saquear un campo ajeno en vez de esperar a sentir curiosidad."
    },
    seedcollector:{
      ...
      notary:"Tu lado Notario guarda el retal por el que nadie más se agachó, así que tu montón se llena de lo que una sala entera pasó por alto.",
      ...
      collider:"Tu lado Colisionador acumula fragmentos como otros acumulan piezas de repuesto, así que dos cualesquiera que saques se pueden estrellar salvando dos campos de distancia.",
      ...
      guardian:"Tu lado Guardián guarda solo lo que tú decidiste que merecía guardarse, así que nada entra en el archivo porque una voz de fuera te dijera que importaba.",
    ...
    notary:{
      ...
      explorer:"Tu lado Explorador lleva esa mirada a territorio ajeno, así que lo raro que ves suele ser también lo que un campo entero pasó por alto.",
      ...
      sketcher:"Tu lado Bocetista convierte esa mirada en acción, y rápido: hila los detalles en borradores en bruto que luego cribas en frío.",
    ...
    collider:{
      ...
      notary:"Tu lado Notario alimenta el choque con detalles pequeños que los demás pasaron por alto, así que las dos cosas que estrellas siguieron invisibles hasta que las emparejaste.",
    ...
    guardian:{
      ...
      seedcollector:"Tu lado Coleccionista mantiene una cámara acorazada llena de todo lo que merece guardarse, y eres el único que tiene la llave de lo que entra y lo que se queda fuera.",
      ...
      reframer:"Tu lado Reformulador rechaza la pregunta tal como llegó y la reescribe en tus términos hasta que aparece otra mejor por debajo.",
      ...
      persona:"Tu lado Personaje elige al creador en el que te metes antes de empezar: un papel que te asignas tú y del que respondes ante ti, no uno que te asignen desde fuera."
    },
    persona:{
      cartographer:"Tu lado Cartógrafo planta en un solo trozo de terreno al personaje en el que te conviertes, así que desde el primer movimiento dominas ese campo y lo cavas más hondo que cualquier otro que toques.",
      explorer:"Tu lado Explorador te hace meterte en un papel prestado de otra parte, así que entras al trabajo con el material en bruto de otro campo y sin ninguna de sus reglas de casa.",
      ...
      notary:"Tu lado Notario arma con un ojo afilado al personaje en el que te metes, así que en cuanto estás en el papel ya estás cazando el detalle raro que los demás pasaron por alto.",
