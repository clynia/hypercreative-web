...
<p>La Empresa opera bajo la marca <strong>Hypercreative</strong>. &quot;Hypercreative&quot; es una marca de Stormridge LLC. Detrás del método está su fundador, <a href="/es/fundador/">Alfonso G. Aguilar</a>, a quien se puede encontrar, pero que no es el centro de todo esto. El trabajo habla primero.</p>
...
<p>El sitio web presenta Hypercreative y el Método Hypercreative, nuestra convicción de que la creatividad es el nuevo activo de negocio, de que se entrena y de que la habilidad de verdad es la creatividad bajo presión. Existe para informar a las organizaciones que encajan con lo que hacemos y para que puedan ponerse en contacto con nosotros. Es un canal informativo y de contacto, no una tienda, y nada de lo que hay en él constituye una oferta vinculante de servicios. Toda colaboración se acuerda por separado y por escrito.</p>
<h3>Propiedad intelectual</h3>
<p>Todo el contenido del sitio web pertenece a Stormridge LLC o a sus licenciantes. Esto incluye el nombre Hypercreative, el término Hypercreativity, el Método Hypercreative, la firma de marca &quot;Entrenamiento en creatividad bajo presión&quot;, y todos los textos, el diseño, la estructura, los gráficos y demás materiales, junto con la metodología, los marcos de trabajo y las técnicas propias que aquí se presentan o se mencionan. El nombre y la marca Hypercreative son marcas de Stormridge LLC.</p>
<p>Todo ello está protegido por la legislación de propiedad intelectual y de marcas. Usted puede consultar el sitio web y conservar copias para su uso interno y no comercial. No puede reproducir, distribuir ni modificar nada de ello, ni usarlo para desarrollar, comercializar o prestar servicios que compitan con los nuestros, ni presentar nuestro método o cualquier parte de él como propio. Todos los derechos no concedidos expresamente quedan reservados.</p>
...
<h3>Ley aplicable</h3>
<p>Este Aviso legal y el uso del sitio web se rigen por las leyes del Estado de Wyoming, Estados Unidos, sin atender a sus normas sobre conflicto de leyes. Cualquier controversia se somete a los tribunales competentes del Estado de Wyoming, sin perjuicio de las normas imperativas de proteccion que puedan resultarle de aplicacion.</p>
<h3>Cambios</h3>
