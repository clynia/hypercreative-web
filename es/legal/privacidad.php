<?php $HC_LANG='es'; $HC_EN='/legal/privacy'; $HC_ES='/es/legal/privacidad'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="es"><head>
<!-- Google Tag Manager -->
...
<title>Política de privacidad | Hypercreative</title>
<meta name="description" content="Política de privacidad de Hypercreative, la marca de entrenamiento creativo para empresas.">
<?php echo hc_hreflang(); ?>
<meta name="robots" content="noindex,follow"><meta property="og:site_name" content="Hypercreative"><meta property="og:locale" content="es_ES"><meta property="og:type" content="website"><meta property="og:title" content="Política de privacidad | Hypercreative"><meta property="og:description" content="Política de privacidad de Hypercreative, la marca de entrenamiento creativo para empresas."><meta property="og:url" content="https://hypercreativemethod.com/es/legal/privacidad"><meta property="og:image" content="https://hypercreativemethod.com/assets/og-default.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Política de privacidad | Hypercreative"><meta name="twitter:description" content="Política de privacidad de Hypercreative, la marca de entrenamiento creativo para empresas."><meta name="twitter:image" content="https://hypercreativemethod.com/assets/og-default.png">
...
<main class="wrap legal"><a class="back" href="/es/">&#8592; Inicio</a><h1 class="t" style="margin-top:1.4rem">Política de privacidad</h1><article><p style="color:var(--mute)">Traducción de cortesía. En caso de discrepancia entre versiones, prevalece la <a href="/legal/privacy?lang=en&amp;remember=0">versión en inglés</a>.</p>
<p><strong>Última actualización: 17 de junio de 2026</strong></p>
<p>Esta Política de privacidad explica cómo <strong>Stormridge LLC</strong>, que opera bajo la marca <strong>Hypercreative</strong> (&quot;Hypercreative&quot;, &quot;la Empresa&quot;, &quot;nosotros&quot;), trata los datos personales recogidos a través de este sitio web. La mantenemos corta y clara a propósito. Si algo no queda claro, pregúntenos a través del formulario de contacto.</p>
<h3>Quién responde de sus datos</h3>
<p><strong>Stormridge LLC</strong> (que opera como Hypercreative) es el responsable de los datos personales recogidos a través del sitio web. Nosotros decidimos por qué y cómo se tratan esos datos. Para contactar con el equipo responsable de la protección de datos, use el formulario de contacto del sitio web o escríbanos a Stormridge LLC, 30 N Gould St Ste R, Sheridan, WY 82801, United States.</p>
<h3>Qué recogemos</h3>
<p>Recogemos solo lo que necesitamos.</p>
<p><strong>Datos que usted nos da.</strong> Cuando usa el formulario de contacto, usted elige qué envía. Normalmente esto incluye su nombre, su correo profesional, su empresa, su cargo y el contenido de su mensaje. Si comparte más, tratamos más, así que envíe solo lo que sea pertinente.</p>
<p><strong>Datos recogidos automáticamente.</strong> Cuando visita el sitio web, nuestros sistemas y nuestros proveedores de servicios pueden registrar datos técnicos como su dirección IP, el tipo de navegador, el tipo de dispositivo, las páginas que ve y la hora y la fecha de su visita. Parte de esto se gestiona mediante cookies y tecnología similar, descritas en nuestra Política de cookies.</p>
<p>No pedimos, y no queremos, categorías especiales de datos. No envíe información personal sensible a través del formulario de contacto.</p>
<h3>Para qué los usamos</h3>
<p>Usamos los datos personales con fines claros y limitados:</p>
<ul>
<li>Para responder a su consulta y hacer seguimiento de una posible colaboración.</li>
...
<p>Aplicamos medidas técnicas y organizativas razonables para proteger los datos personales frente a la pérdida, el uso indebido y el acceso no autorizado. Ningún sitio web ni ningún sistema es completamente seguro, así que no podemos garantizar una seguridad absoluta, pero trabajamos para mantener el riesgo bajo y para reaccionar rápido si algo sale mal.</p>
<h3>Sus derechos</h3>
<p>Según dónde se encuentre, puede tener derecho a:</p>
<ul>
...
<p>El sitio web puede enlazar a otros sitios que no controlamos. Esta Política no los cubre. Lea la política de privacidad de cualquier sitio que visite desde un enlace del nuestro.</p>
<h3>Cambios en esta Política</h3>
<p>Podemos actualizar esta Política cada cierto tiempo. La versión vigente es siempre la publicada aquí, con su fecha al principio. Los cambios sustanciales surten efecto cuando los publicamos.</p>
<h3>Contacto</h3>
<p>Para cualquier duda sobre esta Política o sobre cómo tratamos sus datos, escríbanos a través del formulario de contacto del sitio web.</p></article></main><?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/footer.php'; ?>
