...
<title>Hypercreative: entrenamiento en creatividad bajo presión</title>
...
<meta name="description" content="Hypercreative es entrenamiento en creatividad bajo presión. Conferencias y programas a medida que enseñan a directivos y equipos a crear ideas útiles a demanda.">
<?php echo hc_hreflang(); ?>
<meta name="robots" content="index,follow,max-image-preview:large">
<meta property="og:site_name" content="Hypercreative">
<meta property="og:locale" content="es_ES">
<meta property="og:type" content="website">
<meta property="og:title" content="Hypercreative: entrenamiento en creatividad bajo presión">
<meta property="og:description" content="Entrenamiento en creatividad para empresas y conferencias que enseñan a los equipos directivos a producir trabajo útil y original a demanda, con un plazo real y las reglas cambiando por el camino.">
...
<meta name="twitter:title" content="Hypercreative: entrenamiento en creatividad bajo presión">
<meta name="twitter:description" content="Entrenamiento en creatividad para empresas y conferencias que enseñan a directivos y equipos a crear ideas útiles a demanda.">
<meta name="twitter:image" content="https://hypercreativemethod.com/assets/og-default.png">
<script type="application/ld+json">
{"@context":"https://schema.org","@graph":[
{"@type":"Organization","@id":"https://hypercreativemethod.com/#org","name":"Hypercreative","url":"https://hypercreativemethod.com/","image":"https://hypercreativemethod.com/assets/og-default.png","slogan":"Entrenamiento en creatividad bajo presión","description":"Entrenamiento en creatividad para empresas y conferencias que enseñan a directivos y equipos a crear trabajo útil y original a demanda.","founder":{"@id":"https://hypercreativemethod.com/#alfonso"}},
...
{"@type":"Person","@id":"https://hypercreativemethod.com/#alfonso","name":"Alfonso G. Aguilar","jobTitle":"Fundador y conferenciante","worksFor":{"@id":"https://hypercreativemethod.com/#org"},"description":"Fundador de Hypercreative. Entrena a equipos directivos para crear a demanda, tras años dirigiendo equipos de cine y producción donde el error se paga.","url":"https://hypercreativemethod.com/es/fundador/","image":"https://hypercreativemethod.com/assets/founder/alfonso-g-aguilar.jpg"}
]}
</script>
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  @media(min-width:1200px){.nav .nav-lang{order:3;margin-left:clamp(1.2rem,3vw,2.4rem);margin-right:0}.nav-links{order:2;margin-left:auto}}
  ...
  .nav-links a{white-space:nowrap;position:relative;color:var(--ink-soft);transition:color .3s var(--ease)}
  ...
  @media(max-width:1199px){.nav-toggle{display:flex}.nav-links{position:fixed;top:0;bottom:0;right:0;width:min(80vw,300px);flex-direction:column;justify-content:center;align-items:flex-start;gap:1.7rem;padding:2rem;background:var(--paper);box-shadow:-24px 0 60px -30px rgba(0,0,0,.55);transform:translateX(100%);transition:transform .4s var(--ease);font-size:.85rem;z-index:55}.nav.open .nav-links{transform:none}.nav-links a::after{display:none}.nav-cta{margin-top:.4rem}}
...
<section class="hero" id="top">
  <div class="hero-pin">
    ...
    <div class="hero-inner" id="hero-inner">
      <h1 class="hero-title">
        <span class="sr-only">Hypercreative. Entrenamiento en creatividad bajo presión.</span>
      ...
      <p class="hero-tag reveal" style="--d:.18s">Entrenamiento en creatividad bajo presión<span class="p">.</span></p>
...
<section class="band" id="metodo">
  <h2 class="band-title reveal">El método</h2>
  <p class="lede reveal" style="--d:.06s">Una cuadrícula rígida se convierte en una red viva. <em>Ese es el trabajo.</em></p>
  <p class="method-intro reveal" style="--d:.12s">Entrenamos a directivos y equipos para producir ideas útiles cuando se les pide, con un plazo real y las reglas cambiando por el camino. El trabajo se reparte en tres actos: primero la mente de cada uno, después el equipo, y al final la presión de un rodaje de verdad.</p>
  <div class="acts reveal" role="group" aria-label="Los tres actos del método">
    ...
    <button class="act" type="button" aria-expanded="false">
      ...
      <p class="act-desc">La teoría se muere en cuanto choca con un plazo. Así que lo ponemos todo a trabajar sobre un reto real, con un entregable real y las reglas cambiando a mitad de camino a propósito. Un reloj, límites estrictos y algo en juego: un ensayo de cómo funciona de verdad tu negocio, y el acto donde el método demuestra que aguanta.</p>
    </button>
  </div>
</section>
...
<section class="tq" id="creative-world-cta" aria-label="Haz el test Creative Profile">
  <div class="tq-in">
    ...
    <p class="tq-sub">Los once hábitos del método se reparten en tres familias: alimentar, afilar y proteger. Alrededor de ellas giran nueve perfiles. Veinte preguntas rápidas, siempre entre dos opciones, te dicen en qué perfil estás este trimestre, cuál te corre por debajo y qué hábito te toca entrenar ahora.</p>
