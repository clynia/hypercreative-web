<?php $HC_LANG='es'; $HC_EN='/founder/'; $HC_ES='/es/fundador/'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="es"><head>
<!-- Google Tag Manager -->
...
<title>Alfonso González Aguilar, fundador | Hypercreative</title>
<meta name="description" content="Fundador de Hypercreative. Compuso la música de Klaus, pilotó aviones de línea en Iberia Regional y fundó Sounditi para medir lo que siente la gente."><?php echo hc_hreflang(); ?><meta name="robots" content="index,follow"><meta property="og:site_name" content="Hypercreative"><meta property="og:locale" content="es_ES"><meta property="og:type" content="profile"><meta property="og:title" content="Alfonso González Aguilar, fundador | Hypercreative"><meta property="og:description" content="Fundador de Hypercreative. Compuso la música de Klaus, pilotó aviones de línea en Iberia Regional y fundó Sounditi para medir lo que siente la gente."><meta property="og:url" content="https://hypercreativemethod.com/es/fundador/"><meta property="og:image" content="https://hypercreativemethod.com/assets/founder/og-alfonso-gonzalez-aguilar.jpg"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Alfonso González Aguilar, fundador | Hypercreative"><meta name="twitter:description" content="Fundador de Hypercreative. Compuso la música de Klaus, pilotó aviones de línea en Iberia Regional y fundó Sounditi para medir lo que siente la gente."><meta name="twitter:image" content="https://hypercreativemethod.com/assets/founder/og-alfonso-gonzalez-aguilar.jpg">
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "ProfilePage", "url": "https://hypercreativemethod.com/es/fundador/", "inLanguage": "es", "mainEntity": {"@type": "Person", "@id": "https://hypercreativemethod.com/#alfonso", "name": "Alfonso González Aguilar", "alternateName": "Alfonso G. Aguilar", "jobTitle": "Fundador y conferenciante", "worksFor": {"@id": "https://hypercreativemethod.com/#org"}, "url": "https://hypercreativemethod.com/es/fundador/", "image": "https://hypercreativemethod.com/assets/founder/alfonso-gonzalez-aguilar.jpg", "description": "Fundador de Hypercreative. Compositor de la música de la película de animación Klaus, expiloto de línea aérea en Iberia Regional y fundador de Sounditi."}}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Inicio", "item": "https://hypercreativemethod.com/es/"}, {"@type": "ListItem", "position": 2, "name": "Fundador", "item": "https://hypercreativemethod.com/es/fundador/"}]}</script>
...
<main class="wrap"><a class="back" href="/es/">&#8592; Inicio</a><div class="fhero"><div><h1 class="t">Alfonso González Aguilar</h1><p class="dek">Fundador de Hypercreative. Ha trabajado en tres sitios donde equivocarse sale caro: el cine, la cabina de un avión y una empresa que medía lo que siente la gente. El método nació en el primero.</p></div><figure class="fphoto"><picture><source type="image/webp" srcset="/assets/founder/alfonso-gonzalez-aguilar-600.webp 600w, /assets/founder/alfonso-gonzalez-aguilar.webp 1000w" sizes="(min-width:761px) 290px, 100vw"><img src="/assets/founder/alfonso-gonzalez-aguilar.jpg" srcset="/assets/founder/alfonso-gonzalez-aguilar-600.jpg 600w, /assets/founder/alfonso-gonzalez-aguilar.jpg 1000w" sizes="(min-width:761px) 290px, 100vw" width="1000" height="1250" alt="Alfonso González Aguilar, fundador de Hypercreative" fetchpriority="high"></picture><figcaption>Foto: Daniel Smith</figcaption></figure></div><article><h2>Un método que no nació para venderse</h2><p>Hypercreative empezó como una herramienta interna. Alfonso la construyó para entrenar a sus propios equipos de cine y producción, donde el calendario es imposible, el presupuesto se acaba, el encargo cambia a mitad de camino y aun así el trabajo tiene que ser brillante y llegar a tiempo. Cuando funcionó, lo convirtió en un método que se pudiera enseñar sin él delante. Las empresas llegaron después, a pedirlo.</p><h2>Crear con fecha de entrega</h2><p>Compuso la música de Klaus, la película de animación nominada al Óscar. Para los ochenta minutos de música que quedaron en la película se escribieron ocho horas y veintitrés minutos, más de seis veces lo que sobrevivió. Esa proporción es el método en pequeño: generar sin juzgar y después juzgar sin generar.</p><h2>Ensayar la avería antes</h2><p>Pilotó aviones de línea en Iberia Regional. De la cabina viene una costumbre que recorre todo el entrenamiento: las averías se ensayan en el simulador, no el día que llegan. Por eso en nuestros programas las reglas cambian a propósito.</p><h2>Medir lo que se siente</h2><p>Fundó Sounditi, una empresa que medía segundo a segundo la emoción y la atención de personas reales ante piezas audiovisuales: primero con encefalografía y sensores en un estudio, después con la cámara de cualquier móvil. De ahí le queda al método una convicción. La creatividad no es un don: se entrena, y entrenarla deja una huella que se puede medir.</p><h2>El libro</h2><p>Ha escrito <em>De Creativo a Hipercreativo</em>, el libro donde cuenta el método entero.</p><div class="fnext"><a class="back" href="/es/que-hacemos/">Conferencias y entrenamiento &#8594;</a><a class="back" href="/es/#contacto">Empieza una conversación &#8594;</a></div></article></main><?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/footer.php'; ?>
</body></html>
