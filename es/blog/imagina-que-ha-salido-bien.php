<?php $HC_LANG='es'; $HC_EN='/blog/imagine-it-already-happened'; $HC_ES='/es/blog/imagina-que-ha-salido-bien'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="es"><head>
<!-- Google Tag Manager -->
...
<title>Trabajar hacia atrás desde el futuro | Hypercreative</title>
<meta name="description" content="Trabajar hacia atrás: escribe el comunicado de prensa del futuro antes de empezar y reconstruye desde ahí las decisiones que hicieron real la victoria."><?php echo hc_hreflang(); ?><meta name="robots" content="index,follow"><meta property="og:site_name" content="Hypercreative"><meta property="og:locale" content="es_ES"><meta property="og:type" content="article"><meta property="og:title" content="Trabajar hacia atrás desde el futuro | Hypercreative"><meta property="og:description" content="Trabajar hacia atrás: escribe el comunicado de prensa del futuro antes de empezar y reconstruye desde ahí las decisiones que hicieron real la victoria."><meta property="og:url" content="https://hypercreativemethod.com/es/blog/imagina-que-ha-salido-bien"><meta property="og:image" content="https://hypercreativemethod.com/blog/assets/blog-9.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Trabajar hacia atrás desde el futuro | Hypercreative"><meta name="twitter:description" content="Trabajar hacia atrás: escribe el comunicado de prensa del futuro antes de empezar y reconstruye desde ahí las decisiones que hicieron real la victoria."><meta name="twitter:image" content="https://hypercreativemethod.com/blog/assets/blog-9.png">
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "BlogPosting", "@id": "https://hypercreativemethod.com/es/blog/imagina-que-ha-salido-bien#article", "headline": "Imagina que ha salido bien", "description": "Trabajar hacia atrás: escribe el comunicado de prensa del futuro antes de empezar y reconstruye desde ahí las decisiones que hicieron real la victoria.", "image": "https://hypercreativemethod.com/blog/assets/blog-9.png", "datePublished": "2026-06-18", "dateModified": "2026-06-18", "author": {"@type": "Person", "name": "Alfonso González Aguilar", "@id": "https://hypercreativemethod.com/#alfonso"}, "publisher": {"@id": "https://hypercreativemethod.com/#org"}, "mainEntityOfPage": "https://hypercreativemethod.com/es/blog/imagina-que-ha-salido-bien", "inLanguage": "es", "isPartOf": {"@id": "https://hypercreativemethod.com/es/blog/#blog"}}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Inicio", "item": "https://hypercreativemethod.com/es/"}, {"@type": "ListItem", "position": 2, "name": "Blog", "item": "https://hypercreativemethod.com/es/blog/"}, {"@type": "ListItem", "position": 3, "name": "Imagina que ha salido bien", "item": "https://hypercreativemethod.com/es/blog/imagina-que-ha-salido-bien"}]}</script>
...
<main class="wrap"><a class="back" href="/es/blog/">&#8592; Blog</a><h1 class="t" style="margin-top:1.4rem">Imagina que ha salido bien</h1><p class="byline">Por Alfonso G. Aguilar &middot; 4 min de lectura</p><p class="dek">La forma más rápida de orientar bien un proyecto importante es dar la victoria por conseguida y trabajar hacia atrás desde ella, para encontrar las decisiones que la hicieron real.</p><img class="post-hero" src="/blog/assets/blog-9.png" alt="Un avión de papel impecable en vuelo firme, sostenido por un haz de luz, con la punta del ala en rojo, para ilustrar el trabajo hacia atrás desde una victoria imaginada en el futuro"><article><p>Casi todos los equipos orientan su mejor trabajo poniendo objetivos. Un número que alcanzar, una fecha que cumplir, una casilla en la hoja de ruta. Los objetivos parecen ambición. Casi siempre son papeleo.</p>
<p>Hay un movimiento más afilado, y suena casi demasiado simple. Antes de empezar, sienta al equipo y dile que el trabajo está terminado. No en marcha. Terminado. Ha salido, ha funcionado y todo el mundo tiene delante un resultado mejor de lo que se permitía esperar.</p>
<p>Y entonces haces la única pregunta que importa. Qué hicimos bien.</p>
<blockquote class="pq">Un objetivo te dice hacia dónde apuntar. Una victoria terminada te dice cómo llegar.</blockquote>
<h2>Por qué hablar en futuro te falla</h2>
<p>Pregúntale a un equipo qué aspecto tendría el éxito y te dará algo prudente: una versión ligeramente más grande de hoy. La gente tantea lo que parece alcanzable, porque nadie quiere poner nombre a una ambición que la sala quizá no cumpla. La versión valiente se queda sin decir, y el plan apunta en silencio a lo corriente.</p>
<p>Cambia el tiempo verbal y el techo se mueve. Cuando la victoria se enuncia como un hecho, la gente deja de negociar con lo posible y empieza a describir lo que pasó. La historia hace el trabajo. Una victoria concreta arrastra movimientos concretos, y los movimientos concretos son los que puedes ejecutar.</p>
<p>La versión más clara de esto tiene nombre entre los estrategas. El comunicado de prensa del futuro. Escribes el anuncio del triunfo antes de que exista nada de él, en presente, con el detalle de algo que recuerdas y no de algo que esperas.</p>
<p>El cambio es pequeño y el efecto no lo es. Ya no estás adivinando una mejora vaga. Estás recordando un éxito, y la memoria compromete a la mente de una forma que un objetivo nunca consigue.</p>
<h2>Cómo lo usamos bajo presión</h2>
<p>Esto no lo encontramos en una presentación de estrategia. Lo aprendimos donde hay que ver la pieza terminada antes de poder construirla, porque el presupuesto solo paga un intento. En un rodaje, el plano vive en la cabeza de alguien mucho antes de que la cámara empiece a grabar. Lo describes entero, en voz alta, para que el equipo construya la misma imagen y no cada uno la suya.</p>
<p>Así que antes de que empiece el trabajo, lo terminamos a propósito. Ponemos nombre a la versión más ambiciosa de la victoria, la que a la gente casi le da vergüenza decir. El cliente renovó y trajo a otros tres. El lanzamiento se convirtió en aquello a lo que la competencia tuvo que responder. La idea no solo funcionó: puso las condiciones del mercado.</p>
<p>Después el equipo trabaja hacia atrás desde esa victoria. Cada causa recibe un nombre. El riesgo que mereció la pena correr. El detalle que se ganó la confianza. La decisión valiente que todo el mundo quería en privado y nadie había dicho. Al final no tienes una aspiración vaga. Tienes una lista corta y clara de las decisiones que produjeron el resultado, y la mayoría todavía están por tomar.</p>
<blockquote class="pq">Es más fácil construir un éxito que ya has descrito que perseguir uno que solo has imaginado a medias.</blockquote>
<p>Esto es creatividad bajo presión, que es la única que paga. Cualquiera sueña a lo grande en una sala tranquila y sin nada en juego. La habilidad que mueve un negocio es la que convierte una ambición vívida en el camino concreto que llega hasta ella, con el plazo encima y con un precio alto por apuntar bajo. Imaginar primero la victoria es la forma de construir un trabajo que tira del futuro hacia sí en vez de conformarse con el presente.</p>
<h2>Que sea un hábito, no un deseo</h2>
<p>La trampa es tratar esto como una charla motivacional. Un equipo que se imagina el triunfo para sentirse inspirado, disfruta del subidón y después planifica exactamente igual que antes ha desperdiciado la hora. El objetivo no es sentirse ambicioso. El objetivo es salir de la sala con el trabajo apuntando más alto que al entrar.</p>
<p>Así que pon una regla sencilla. Cada movimiento que saque el ejercicio recibe una de tres salidas antes de que la sesión avance: se compromete ya, se empieza a construir ya o se suelta a propósito, con los ojos abiertos. Ninguna decisión valiente se queda en ese limbo donde todos la vieron y nadie la firmó.</p>
<p>Hazlo las veces suficientes y algo cambia en la forma de pensar del equipo. La gente deja de encoger las ideas para que quepan en el plan y empieza a hacer crecer el plan para que quepa la idea. La ambición deja de parecer riesgo y empieza a parecer dirección. La versión más fuerte del trabajo es la que ya ha sido descrita como victoria y después construida hacia atrás hasta la realidad.</p>
<p>Este es el gemelo optimista de un ejercicio más oscuro por el que ponemos la mano en el fuego, el de <a href="/es/blog/imagina-que-ha-salido-mal" target="_blank" rel="noopener">Imagina que ha salido mal</a>. El premortem protege el trabajo haciéndote vivir su derrumbe. Este lo apunta más alto haciéndote vivir su triunfo. Ejecútalos juntos y tienes el cuadro completo: el suelo y el techo, el peligro y el destino.</p>
<p>La creatividad es <a href="/es/blog/la-creatividad-es-el-nuevo-activo" target="_blank" rel="noopener">el activo que decide qué empresas se adelantan</a>, y se entrena. Esta es una de las formas más baratas de entrenarla. Sin presupuesto nuevo y sin herramientas nuevas. Solo la disciplina de imaginar la victoria con claridad y actuar en consecuencia.</p>
<div class="takeaway"><span class="tk-label">Lo que te llevas</span><p>Termina el trabajo primero en tu cabeza. Después construye lo que ya has visto.</p></div></article></main><?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/footer.php'; ?>
