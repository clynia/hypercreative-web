<?php $HC_LANG='en'; $HC_EN='/legal/legal-notice'; $HC_ES='/es/legal/aviso-legal'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="en"><head>
<!-- Google Tag Manager -->
...
<p>All content on the website belongs to Stormridge LLC or to those who license it to us. This includes the name Hypercreative, the term Hypercreativity, the Hypercreative Method, the brand signature &quot;Creativity training under pressure&quot;, and all text, design, structure, graphics, and other materials, together with the underlying methodology, frameworks, and proprietary techniques presented or referenced here. The Hypercreative name and brand are trademarks of Stormridge LLC.</p>
