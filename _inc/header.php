...
.snav .nav-lang a{color:#9a988f;transition:color .3s ease}
.snav .nav-lang a:hover{color:#13130F}
...
<header class="snav" id="nav"><a class="brand" href="<?php echo $es ? '/es/' : '/'; ?>">Hypercreative<span class="bp">.</span></a><?php echo function_exists('hc_lang_switch') ? hc_lang_switch() : ''; ?><button class="snav-toggle" id="navToggle" type="button" data-open="<?php echo $es ? 'Abrir men&uacute;' : 'Open menu'; ?>" data-close="<?php echo $es ? 'Cerrar men&uacute;' : 'Close menu'; ?>" aria-label="<?php echo $es ? 'Abrir men&uacute;' : 'Open menu'; ?>" aria-expanded="false" aria-controls="navLinks"><span></span><span></span><span></span></button><nav class="snav-links" id="navLinks" aria-label="<?php echo $es ? 'Principal' : 'Primary'; ?>"><?php if ($es): ?><a href="/es/#metodo">El m&eacute;todo</a><a href="/es/que-hacemos/">Qu&eacute; hacemos</a><a class="nav-hot" href="/es/perfil-creativo/">Creative Profile</a><a href="/es/blog/">Blog</a><a href="/es/prensa/">Prensa</a><a class="nav-cta" href="/es/#contacto">Hablemos</a><?php else: ?><a href="/#method">The method</a><a href="/what-we-do/">What we do</a><a class="nav-hot" href="/creative-profile/">Creative Profile</a><a href="/blog/">Blog</a><a href="/press/">Press</a><a class="nav-cta" href="/#request">Let&#39;s talk</a><?php endif; ?></nav></header>
