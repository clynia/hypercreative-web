...
.nav-lang{display:inline-flex;align-items:center;gap:.45em;color:#9a988f}
.snav-links .nav-lang a{color:#9a988f}
.snav-links .nav-lang a:hover{color:#13130F}
.snav-links .nav-lang a::after{display:none}
.nav-lang .on{color:#13130F}
.nav-lang i{font-style:normal;opacity:.4}
</style>
<?php $es = (isset($HC_LANG) && $HC_LANG === 'es'); ?>
<header class="snav" id="nav"><a class="brand" href="<?php echo $es ? '/es/' : '/'; ?>">Hypercreative<span class="bp">.</span></a><button class="snav-toggle" id="navToggle" type="button" data-open="<?php echo $es ? 'Abrir men&uacute;' : 'Open menu'; ?>" data-close="<?php echo $es ? 'Cerrar men&uacute;' : 'Close menu'; ?>" aria-label="<?php echo $es ? 'Abrir men&uacute;' : 'Open menu'; ?>" aria-expanded="false" aria-controls="navLinks"><span></span><span></span><span></span></button><nav class="snav-links" id="navLinks" aria-label="<?php echo $es ? 'Principal' : 'Primary'; ?>"><?php if ($es): ?><a href="/es/#metodo">El m&eacute;todo</a><a href="/es/que-hacemos/">Qu&eacute; hacemos</a><a class="nav-hot" href="/es/perfil-creativo/">Creative Profile</a><a href="/es/blog/">Blog</a><a href="/es/prensa/">Prensa</a><a class="nav-cta" href="/es/#contacto">Hablemos</a><?php else: ?><a href="/#method">The method</a><a href="/what-we-do/">What we do</a><a class="nav-hot" href="/creative-profile/">Creative Profile</a><a href="/blog/">Blog</a><a href="/press/">Press</a><a class="nav-cta" href="/#request">Let&#39;s talk</a><?php endif; ?><?php echo function_exists('hc_lang_switch') ? hc_lang_switch() : ''; ?></nav></header>
<script>(function(){var n=document.getElementById("nav"),t=document.getElementById("navToggle");if(!n||!t)return;function set(o){n.classList.toggle("open",o);t.setAttribute("aria-expanded",o?"true":"false");t.setAttribute("aria-label",o?(t.getAttribute("data-close")||"Close menu"):(t.getAttribute("data-open")||"Open menu"));}t.addEventListener("click",function(){set(!n.classList.contains("open"));});n.querySelectorAll(".snav-links a").forEach(function(a){a.addEventListener("click",function(){set(false);});});})();</script>
