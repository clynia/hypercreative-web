...
<header class="snav" id="nav"><a class="brand" href="/">Hypercreative<span class="bp">.</span></a><button class="snav-toggle" id="navToggle" type="button" aria-label="Open menu" aria-expanded="false" aria-controls="navLinks"><span></span><span></span><span></span></button><nav class="snav-links" id="navLinks" aria-label="Primary"><a href="/#method">The method</a><a href="/what-we-do/">What we do</a><a class="nav-hot" href="/creative-world/">Creative World</a><a href="/blog/">Blog</a><a href="/press/">Press</a><a class="nav-cta" href="/#request">Let&#39;s talk</a></nav></header>
