<?php $HC_LANG='en'; $HC_EN='/press/'; $HC_ES='/es/prensa/'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="en"><head>
<!-- Google Tag Manager -->
...
<title>Press &amp; Media Kit | Hypercreative</title>
<meta name="description" content="Logos, the brand manual, colours, typography and boilerplate for press and partners of Hypercreative."><?php echo hc_hreflang(); ?><meta name="robots" content="index,follow"><meta property="og:site_name" content="Hypercreative"><meta property="og:locale" content="en_US"><meta property="og:type" content="website"><meta property="og:title" content="Press &amp; Media Kit | Hypercreative"><meta property="og:description" content="Logos, the brand manual, colours, typography and boilerplate for press and partners of Hypercreative."><meta property="og:url" content="https://hypercreativemethod.com/press/"><meta property="og:image" content="https://hypercreativemethod.com/assets/og-default.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="Press &amp; Media Kit | Hypercreative"><meta name="twitter:description" content="Logos, the brand manual, colours, typography and boilerplate for press and partners of Hypercreative."><meta name="twitter:image" content="https://hypercreativemethod.com/assets/og-default.png">
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://hypercreativemethod.com/"}, {"@type": "ListItem", "position": 2, "name": "Press", "item": "https://hypercreativemethod.com/press/"}]}</script>
...
<h2>Boilerplate</h2>
<span class="lead">Short</span>
<div class="bp-card"><button class="copy" type="button" aria-label="Copy short boilerplate">Copy</button><p>Hypercreative trains the teams of the world&#8217;s most demanding companies to create useful ideas on demand. It turns creativity from a personality trait into a trainable discipline.</p></div>
<span class="lead">Long</span>
<div class="bp-card"><button class="copy" type="button" aria-label="Copy long boilerplate">Copy</button><p>Hypercreative is a corporate creativity training company. It teaches leadership teams and their people to generate useful, original ideas on demand, through keynotes and tailor-made programmes. The method was built inside high-pressure creative teams in film and production and is now exported to large organisations. Hypercreative is a trademark.</p></div>

<h2>Logo</h2>
<p>Always use the supplied files. Keep clear space around the wordmark and never alter, recolour, rotate or re-typeset it. See the brand manual for full rules.</p>
<div class="logo-grid">
<div><div class="logo-card light"><img src="../assets/press/logo-light.svg" alt="Hypercreative wordmark in dark on a light background"></div><div class="dls"><a class="dl" href="../assets/press/logo-light.svg" download><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3v12m0 0l-4-4m4 4l4-4M5 21h14"/></svg> SVG</a><a class="dl" href="../assets/press/logo-light.png" download><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3v12m0 0l-4-4m4 4l4-4M5 21h14"/></svg> PNG</a></div></div>
<div><div class="logo-card dark"><img src="../assets/press/logo-dark.svg" alt="Hypercreative wordmark reversed in light on a dark background"></div><div class="dls"><a class="dl" href="../assets/press/logo-dark.svg" download><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3v12m0 0l-4-4m4 4l4-4M5 21h14"/></svg> SVG</a><a class="dl" href="../assets/press/logo-dark.png" download><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3v12m0 0l-4-4m4 4l4-4M5 21h14"/></svg> PNG</a></div></div>
</div>
...
<div class="ai-logos" role="img" aria-label="Works with ChatGPT, Claude, Gemini, Copilot and Grok">
...
1. USE THE OFFICIAL FILES (never redraw or re-type the logo)
   ...
   Wordmark for light backgrounds (SVG): https://hypercreativemethod.com/assets/press/logo-light.svg
   Wordmark for light backgrounds (PNG): https://hypercreativemethod.com/assets/press/logo-light.png
   Wordmark for dark backgrounds (SVG): https://hypercreativemethod.com/assets/press/logo-dark.svg
   Wordmark for dark backgrounds (PNG): https://hypercreativemethod.com/assets/press/logo-dark.png
   Symbol, the red dot (SVG): https://hypercreativemethod.com/assets/press/logo-mark.svg
   Full brand manual (PDF): https://hypercreativemethod.com/assets/press/Hypercreative-Brand-Manual.pdf

2. WHAT THE LOGO IS
   The logo is the single word "Hypercreative" set in Inter Medium, closed by one solid red dot, the ignition point. The dot is part of the logo. Never drop it.
   There are two versions only:
   - Positive: dark wordmark (ink #13130F) with the red dot (#E0463C). Use on light backgrounds.
   - Reverse: light wordmark (paper #F7F6F3) with the red dot. Use on dark backgrounds.
   The dot is always red, in both versions.

3. ALWAYS
   - Use the supplied file, unchanged.
   - Pick the version by background: light background uses positive, dark background uses reverse.
   - Leave clear space around the logo of at least one dot-diameter on every side.
   - Keep it at least 104px (or 28mm) wide. Below that, use the red dot on its own, down to 16px.
   - Keep a contrast of at least 4.5 to 1 between the wordmark and its background.

4. NEVER
   - Never re-type the wordmark in another font or weight. It is Inter Medium.
   - Never recolour the wordmark or the dot, and never add gradients, shadows, outlines or a box.
   - Never stretch, squeeze, rotate, skew or curve it.
   - Never move, resize or remove the red dot, or swap it for another shape.
   - Never place it on a busy image, a red area, or a mid-tone background.
   - Never put more than one red element in the same view.

5. COLOURS
   Ink #13130F. Paper #F7F6F3. White #FFFFFF. Red #E0463C (accent only, one red per view).

6. VERIFY (every answer must be yes)
   - Official file used, not redrawn?
   - Right version for the background (light uses positive, dark uses reverse)?
   - Red dot present and red?
   - Wordmark untouched: Inter Medium, not stretched or rotated?
   - Clear space kept, and size at or above the minimum?
   - Only one red element in the whole view?
   If any answer is no, it is off-brand. Fix it before you ship.

Official files and the full manual: https://hypercreativemethod.com/press/</pre></div>
<p style="font-size:.92rem;color:var(--soft);margin-top:.6rem">Prefer a file? <a class="prompt-txt" href="../assets/press/hypercreative-brand-prompt.txt" download>Download the prompt as .txt</a></p>
...
<h2>Colour</h2>
<p>One red event per view. The red is an accent, never a background or body colour.</p>
<div class="sw-grid"><div class="sw"><div class="chip" style="background:#13130F;"></div><div class="m"><div class="nm">Ink</div><div class="hx">#13130F</div><div class="rl">Primary / text</div></div></div><div class="sw"><div class="chip" style="background:#F7F6F3;box-shadow:inset 0 0 0 1px var(--line)"></div><div class="m"><div class="nm">Paper</div><div class="hx">#F7F6F3</div><div class="rl">Surface</div></div></div><div class="sw"><div class="chip" style="background:#FFFFFF;box-shadow:inset 0 0 0 1px var(--line)"></div><div class="m"><div class="nm">White</div><div class="hx">#FFFFFF</div><div class="rl">Surface</div></div></div><div class="sw"><div class="chip" style="background:#E0463C;"></div><div class="m"><div class="nm">Red</div><div class="hx">#E0463C</div><div class="rl">Accent (one per view)</div></div></div><div class="sw"><div class="chip" style="background:#56554E;"></div><div class="m"><div class="nm">Ink soft</div><div class="hx">#56554E</div><div class="rl">Secondary</div></div></div><div class="sw"><div class="chip" style="background:#9A988F;"></div><div class="m"><div class="nm">Ink mute</div><div class="hx">#9A988F</div><div class="rl">Tertiary / labels</div></div></div></div>
