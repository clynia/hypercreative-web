<?php $HC_LANG='en'; $HC_EN='/blog/imagine-it-already-failed'; $HC_ES='/es/blog/imagina-que-ha-salido-mal'; include $_SERVER['DOCUMENT_ROOT'].'/_inc/lang.php'; ?><!DOCTYPE html><html lang="en"><head>
<!-- Google Tag Manager -->
...
<title>How to Run a Premortem | Hypercreative</title>
<meta name="description" content="How to run a premortem: imagine your project already failed, then work backward to find what to fix while there&#x27;s still time. A simple, high-leverage team habit."><?php echo hc_hreflang(); ?><meta name="robots" content="index,follow"><meta property="og:site_name" content="Hypercreative"><meta property="og:locale" content="en_US"><meta property="og:type" content="article"><meta property="og:title" content="How to Run a Premortem | Hypercreative"><meta property="og:description" content="How to run a premortem: imagine your project already failed, then work backward to find what to fix while there&#x27;s still time. A simple, high-leverage team habit."><meta property="og:url" content="https://hypercreativemethod.com/blog/imagine-it-already-failed"><meta property="og:image" content="https://hypercreativemethod.com/blog/assets/blog-8.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="How to Run a Premortem | Hypercreative"><meta name="twitter:description" content="How to run a premortem: imagine your project already failed, then work backward to find what to fix while there&#x27;s still time. A simple, high-leverage team habit."><meta name="twitter:image" content="https://hypercreativemethod.com/blog/assets/blog-8.png">
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "BlogPosting", "@id": "https://hypercreativemethod.com/blog/imagine-it-already-failed#article", "headline": "Imagine It Already Failed", "description": "How to run a premortem: imagine your project already failed, then work backward to find what to fix while there's still time. A simple, high-leverage team habit.", "image": "https://hypercreativemethod.com/blog/assets/blog-8.png", "datePublished": "2026-06-18", "dateModified": "2026-06-18", "author": {"@type": "Person", "name": "Alfonso González Aguilar", "@id": "https://hypercreativemethod.com/#alfonso"}, "publisher": {"@id": "https://hypercreativemethod.com/#org"}, "mainEntityOfPage": "https://hypercreativemethod.com/blog/imagine-it-already-failed", "inLanguage": "en", "isPartOf": {"@id": "https://hypercreativemethod.com/blog/#blog"}}</script><script type="application/ld+json">{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Home", "item": "https://hypercreativemethod.com/"}, {"@type": "ListItem", "position": 2, "name": "Blog", "item": "https://hypercreativemethod.com/blog/"}, {"@type": "ListItem", "position": 3, "name": "Imagine It Already Failed", "item": "https://hypercreativemethod.com/blog/imagine-it-already-failed"}]}</script>
...
<main class="wrap"><a class="back" href="./">&#8592; Blog</a><p class="eyebrow" style="margin-top:1.4rem">Blog</p><h1 class="t">Imagine It Already Failed</h1><p class="byline">By Alfonso G. Aguilar &middot; 4 min read</p><p class="dek">The fastest way to protect important work is to assume it already collapsed, then work backward from the wreckage to find what to fix while there is still time.</p><img class="post-hero" src="assets/blog-8.png" alt="A crumpled paper aeroplane with a bent torn wing and a faint red scuff at the point of impact, illustrating a premortem imagining failure in advance"><article><p>Most teams protect their best work by believing in it. They polish the deck, rehearse the pitch, and walk into the launch convinced it will land. Confidence feels like preparation. It is not.</p>
<p>There is a sharper move, and it sounds backward. Before you launch, sit the team down and tell them the project is dead. Not at risk. Dead. It shipped, it failed, and everyone is looking at the rubble trying to understand why.</p>
<p>Then you ask the only question that matters. What killed it.</p>
<blockquote class="pq">Confidence walks you into the launch. It does not walk you out alive.</blockquote>
<h2>Why the future tense fails you</h2>
<p>Ask a team what could go wrong and you get a polite, careful list. People hedge. Nobody wants to be the one predicting disaster on a project the room has already fallen in love with. So the real risks stay quiet, and the launch carries them anyway.</p>
<p>Change the tense and everything loosens. Once failure is stated as fact, people stop defending the plan and start explaining the crash. The story does the work. A specific collapse pulls out specific reasons, and specific reasons are the ones you can actually fix.</p>
<p>The psychologist Gary Klein coined the term for this. He called it a premortem. A postmortem studies a death that already happened. A premortem studies one you can still prevent, by imagining it has happened and tracing it back.</p>
<p>The shift is small and the effect is not. You are no longer guessing at vague dangers. You are remembering a failure, and memory is far more honest than prediction.</p>
<h2>How we use it under pressure</h2>
<p>We did not pick this up from a textbook. We learned it where a single bad assumption costs a day of shooting that cannot be reshot. On a set, you cannot afford to discover the flaw at the moment it detonates. You hunt for it first, out loud, before anyone calls action.</p>
<p>So before the work goes out, we kill it on purpose. We name the most embarrassing version of the failure, the one nobody wants to say. The client walked. The product launched to silence. The big idea looked clever in the room and meant nothing in the market.</p>
<p>Then the team works backward from that wreckage. Every reason gets a name. The timeline that was always too tight. The objection nobody answered. The assumption everyone treated as a fact. By the end you are not holding a vague worry. You are holding a short, brutal list of things to fix while fixing them is still cheap.</p>
<blockquote class="pq">It is easier to prevent a failure you have already lived through than one you are still pretending cannot happen.</blockquote>
<p>This is creativity under pressure, which is the only kind that pays. Anyone can generate ideas in a calm room with no stakes. The skill that moves a business is the one that holds up when the deadline is real and the cost of being wrong is high. Imagining the failure first is how you build ideas that survive contact with the world instead of cracking on impact.</p>
<h2>Make it a habit, not a ritual</h2>
<p>The trap is treating this as a box to tick. A team that runs the exercise to feel responsible, nods at the risks, then changes nothing has wasted the hour. The point is not to feel prepared. The point is to leave the room with the work actually different than when you walked in.</p>
<p>So set a small rule. Every risk the premortem surfaces gets one of three answers before anyone moves on. Fix it now, plan for it now, or accept it on purpose with eyes open. No risk gets to sit in the quiet middle where everyone saw it and nobody owned it.</p>
<p>Do this often enough and something changes in how the team thinks. People stop protecting ideas and start stress testing them. Doubt stops feeling like disloyalty and starts feeling like care. The strongest version of the work is the one that has already been put through its own death and walked out standing. This exercise has an optimistic twin worth running beside it, where instead of the collapse you <a href="imagine-it-already-happened" target="_blank" rel="noopener">imagine the win has already arrived</a> and work backward from it. Together they give you the floor and the ceiling.</p>
<p>Creativity is <a href="creativity-is-the-ultimate-asset" target="_blank" rel="noopener">the asset that decides which companies pull ahead</a>, and it is trainable. This is one of the cheapest ways to train it. No new budget, no new tools. Just the discipline to imagine the worst clearly, then act on what you find.</p>
<div class="takeaway"><span class="tk-label">The takeaway</span><p>Kill the work in your head first. Whatever survives is worth launching.</p></div></article></main><?php include $_SERVER['DOCUMENT_ROOT'].'/_inc/footer.php'; ?>
