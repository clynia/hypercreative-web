...
<main class="wrap"><a class="back" href="./">&#8592; Blog</a><h1 class="t" style="margin-top:1.4rem">Imagine It Already Happened</h1><p class="byline">By Alfonso G. Aguilar &middot; 4 min read</p><p class="dek">The fastest way to aim important work is to assume the win already arrived, then work backward from the victory to find the decisions that made it real.</p><img class="post-hero" src="assets/blog-9.png" alt="A pristine paper aeroplane in confident flight lifted on a shaft of light with a red wingtip, illustrating working backwards from an imagined future win"><article><p>Most teams aim their best work by setting goals. A number to hit, a date to make, a box on a roadmap. Goals feel like ambition. Usually they are just admin.</p>
