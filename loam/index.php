...
<meta property="og:title" content="Loam · Seed anything. Grow ideas.">
<meta property="og:description" content="An anti-hoarding seed bank for your ideas. Capture anything without sorting. When a real problem needs an idea, your own ground hands it back as questions, never answers.">
<meta property="og:url" content="https://hypercreativemethod.com/loam/">
<meta property="og:image" content="https://hypercreativemethod.com/loam/assets/og-loam.png">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Loam · Seed anything. Grow ideas.">
<meta name="twitter:description" content="An anti-hoarding seed bank for your ideas. Your own ground, handed back as questions, never answers.">
<meta name="twitter:image" content="https://hypercreativemethod.com/loam/assets/og-loam.png">
<script type="application/ld+json">
{"@context":"https://schema.org","@graph":[
{"@type":"SoftwareApplication","@id":"https://hypercreativemethod.com/loam/#app","name":"Loam","applicationCategory":"ProductivityApplication","operatingSystem":"Web","url":"https://loam.hypercreativemethod.com","inLanguage":"en","description":"An anti-hoarding seed bank for ideas. Capture any fragment without sorting. When a real problem needs an idea, your own material comes back as bridge questions, never answers.","isPartOf":{"@id":"https://hypercreativemethod.com/#org"},"publisher":{"@type":"Organization","name":"Hypercreative"},"offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}},
{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://hypercreativemethod.com/"},{"@type":"ListItem","position":2,"name":"Loam","item":"https://hypercreativemethod.com/loam/"}]}
]}
</script>
...
<header class="nav" id="nav">
  <a class="brand" href="#top">Loam<span class="s">.</span><span class="end">a Hypercreative tool</span></a>
...
<section class="hero" id="top">
  ...
  <div class="hero-inner">
    ...
    <div class="actions reveal" style="--d:.28s">
      <a class="btn btn-primary" href="https://loam.hypercreativemethod.com">Open Loam</a>
      <a class="btn btn-ghost" href="https://loam.hypercreativemethod.com/demo">See the live demo</a>
    </div>
    <p class="cta-note reveal" style="--d:.3s">Free. Opens in your browser, nothing to download.</p>

    <div class="conx reveal" id="conx" style="--d:.32s" aria-label="How the connector works">
      <span class="conx-lbl lbl">two things you saved</span>
      <div class="cg">
        <div class="cg-row">
          <div class="cg-cell"><span class="cg-chip">a client complaint</span></div>
          <div class="cg-cell"><span class="cg-chip">scaffolding photo</span></div>
        </div>
        <div class="cg-wire">
        ...
        <p class="cg-q">What would you build if the complaint were load-bearing?</p>
        <p class="cg-cap">One question that connects two of your notes. The idea is yours to make.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="band" id="what">
  <h2 class="lede reveal">One place for every idea you would otherwise lose.</h2>
  <p class="sub j reveal" style="--d:.08s">A line you liked. A link worth keeping. A photo of a page. A voice note in the car. Drop it in one tap and never sort it again.</p>
  <div class="cards">
    <div class="card reveal">
      <div class="thumb th-note">
        <div class="th-note-title">Idea</div>
        <div class="th-note-body">People don't buy drills, they buy holes.</div>
        <div class="th-note-meta">Yesterday, 9:41</div>
      </div>
      <span class="k">Note</span><p class="t">A line you liked.</p>
    </div>
    <div class="card reveal" style="--d:.08s">
      <div class="thumb th-link">
        ...
        <a class="th-link-a">How Duolingo uses streaks to keep users coming back</a>
        <p class="th-link-desc">Streaks, reminders, and loss aversion as retention mechanics.</p>
      </div>
      <span class="k">Link</span><p class="t">A link worth keeping.</p>
    </div>
    <div class="card reveal" style="--d:.16s">
      <div class="thumb th-shot">
        ...
        <div class="th-shot-body">
          <div class="th-shot-title">The best interfaces disappear</div>
          <p class="th-shot-text">Good design gets out of the way. <mark>When it works, you stop noticing it.</mark></p>
        </div>
      </div>
      <span class="k">Photo</span><p class="t">A page you shot, read with OCR.</p>
    </div>
  </div>
</section>
...
<section class="quiet" id="why">
  <div class="quiet-in">
    <h2 class="h reveal">Your best ideas arrive at the worst moment, then vanish.</h2>
    <p class="q reveal" style="--d:.1s">"The brain does not store the idea you failed to capture. It moves on." Loam is the place to catch every one of them before it goes.</p>
    <span class="cite reveal" style="--d:.18s">From the Hypercreative method on working under pressure</span>
  </div>
</section>

<section class="band" id="how">
  <h2 class="lede reveal">Three moves. Nothing to organize.</h2>
  <div class="steps">
    <div class="step reveal"><div class="n"><b>01</b> Save</div><div class="st">Drop it in</div><p class="sd j">Any fragment goes in with one tap. No tags, no folders, ever. Capture has to cost almost nothing, so you never stop doing it.</p></div>
    <div class="step reveal" style="--d:.1s"><div class="n"><b>02</b> Wait</div><div class="st">Loam reads it</div><p class="sd j">In the background, a photo goes through OCR, a voice note is transcribed, a link is summarized. You do nothing. Nothing to organise.</p></div>
    <div class="step reveal" style="--d:.2s"><div class="n"><b>03</b> Connect</div><div class="st">Get unstuck</div><p class="sd j">Pose a real problem. Loam brings your own notes back, near and far, each turned into a question. Including something you had forgotten.</p></div>
  </div>
</section>

<section class="band diff" id="connector">
  <h2 class="lede center reveal">Not an answer machine. It brings your own ideas back.</h2>
  <p class="sub center j reveal" style="--d:.08s">Type the problem you are stuck on. Loam surfaces your own saved notes, some close to the problem and some far from it, and turns them into one question that connects them. It never writes the idea for you, so the breakthrough stays yours.</p>
  <div class="nf reveal" style="--d:.14s">
    <div class="nf-col">
      <span class="lbl">Near your problem</span>
      <span class="chip2">a client complaint</span>
      <span class="chip2">last month's pitch</span>
    </div>
    <div class="nf-mid">
      <span class="nf-seed"></span>
      <span class="m">one bridge question</span>
    </div>
    <div class="nf-col">
      <span class="lbl">Far from it</span>
      <span class="chip2">scaffolding photo</span>
      <span class="chip2">a line from a film</span>
    </div>
  </div>
</section>

<section class="band" id="handoff">
  <h2 class="lede reveal">Loam does not solve it. Your own AI does.</h2>
  <p class="sub j reveal" style="--d:.08s">Solving is what AI is for. So one tap builds a prompt with your related seeds already inside it, ready to paste into ChatGPT, Claude, or whatever you use. The answer comes back built from your own ideas, and you start the conversation from there, not from a blank page.</p>
  <div class="prompt-card reveal" style="--d:.14s">
    <div class="pc-top">
      <span class="lbl">Prompt for your AI</span>
      <span class="pc-copy">Copy</span>
    </div>
    <p class="pc-line">You are my thinking partner. My problem:</p>
    <p class="pc-quote">"How do I get new users to stick around?"</p>
    <p class="pc-line">Built from my own saved material:</p>
    <ul class="pc-seeds">
      <li>People don't buy drills, they buy holes.</li>
      <li>Games teach their rules without a manual.</li>
      <li>Origami: one sheet, endless forms, zero waste.</li>
    </ul>
  </div>
</section>

<section class="band" id="advantages">
  <h2 class="lede reveal">Made to stay out of your way.</h2>
  <p class="sub j reveal" style="--d:.06s">A notes app stores what you save and leaves it there. Loam is the one that hands it back, at the moment a real problem needs it.</p>
  <div class="adv">
    <div class="a reveal"><div class="at">Zero friction</div><p class="ad">Capture in one tap. Sort nothing, ever.</p></div>
    <div class="a reveal" style="--d:.05s"><div class="at">Anything is a seed</div><p class="ad">Text, links, photos, voice, a whole notes file split into many.</p></div>
    <div class="a reveal" style="--d:.1s"><div class="at">Your own material</div><p class="ad">It only ever returns what you fed it, as questions.</p></div>
    <div class="a reveal" style="--d:.15s"><div class="at">The idea stays yours</div><p class="ad">No generic answers, no scores, no AI slop. Only your own material.</p></div>
    <div class="a reveal" style="--d:.2s"><div class="at">Private by default</div><p class="ad">Export your bank whole or delete everything, anytime.</p></div>
    <div class="a reveal" style="--d:.25s"><div class="at">Works offline</div><p class="ad">Plant a seed anywhere. It syncs when you are back.</p></div>
  </div>
</section>

<section class="quiet" id="close">
  <div class="quiet-in">
    <h2 class="h reveal">Never start from a blank page again.</h2>
    <p class="q reveal" style="--d:.1s">The hard part was never having ideas. It was having one ready when it counts.</p>
    <div class="actions reveal" style="--d:.18s;justify-content:center">
      <a class="btn btn-primary" href="https://loam.hypercreativemethod.com">Open Loam</a>
      <a class="btn btn-ghost" href="https://loam.hypercreativemethod.com/demo">See the demo</a>
    </div>
  </div>
</section>
...
<footer id="contact">
  <div class="foot">
    ...
    <div class="foot-r">
      <a href="https://loam.hypercreativemethod.com">Open Loam</a>
      <a href="https://hypercreativemethod.com/">Hypercreative</a>
    </div>
  </div>
  <p class="fine">Loam is made by Hypercreative&#8482;, a company that trains leaders and teams to create on demand. &copy; 2026 Hypercreative.</p>
</footer>
